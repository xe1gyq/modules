...
Connect your Intel Edison using both USB cables, once installed check in Device Manager, under **Ports (COM & LPT)** which port your Edison has been assigned with the label
